...
<body>
   ...
   <div id='Content'>
     ...
     <div><blockquote id='bq' data-text='㋡'>
       ...
       <p id="pesan3">Ciee.. udah sempro udah mau selangkah lagi nih 🤣❤️</p>

       <p id="pesan4">congratulation risma camokk, </p>

       <p id="pesan5" class="gaya2">mkin sukses,suksesnya jangan sndiri hehe</p>

       <p id="pesan6" class="gaya2">terpenting adalah jadi risma yang nurut baik jangan ngambek yh wkwk 😆❤️</p>

       <p id="pesan7" class="gaya2">Sehat selalu ya jangan galau!</p>
...
<script>
  ...
  var tanya = 'kado itu langkah awal  😶❤️';

  var opstanya = 'saya siap mnemanimu bertumbuh 😆';

  var tompositif = 'Mau jadi adik kakak lagi';
